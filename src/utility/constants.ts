import { HOMESLIDEDATA, MENUCATEGORY, NAVMENULINKS, PRODUCT } from "./types";

// ====================== Mobile Navbar Item ======================
export const homeNavLink: NAVMENULINKS[] = [
  { id: 1, name: "Home Page", link: "/" },
  { id: 2, name: "Menu", link: "/menu" },
  { id: 3, name: "Working Hours", link: "/" },
  { id: 4, name: "Contact", link: "/" }
];

// ====================== Home Slide Data ======================
export const homeSlideData: HOMESLIDEDATA[] = [
  {
    id: 1,
